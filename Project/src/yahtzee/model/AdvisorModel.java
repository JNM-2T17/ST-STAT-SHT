...
public class AdvisorModel {
    ...
    public static String calculateFullHouseProbability(DiceSet diceSet){
        ...
        if(hasTwo==2){
            ...
            diceToReRoll = diceToReRoll.substring(0, diceToReRoll.length()-2);
            return out+"33.33%, re-rolling die "+diceToReRoll;
        }
        else if(max==1){
            out += "2.3148%, re-rolling dice 2, 3, 4, 5";
        } else if(max==2){
            ...
            out += "why bother, you shouldn't even be aiming for a Full House right now :P";
        }
        return out;
    }
    ...
    public static String calculateFourOfAKindProbability(DiceSet diceSet){
